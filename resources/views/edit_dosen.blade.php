    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info">
      ...
      <div class="row no-gutters">
          ...
          <div class="col-md-9 mt-5 ml-5">
              ...
              <h3><i class="fas fa-user-graduate"></i> UBAH DOSEN</h3><hr>

              <form method="post" action="/dosen/update">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputEmail3" name="nim" value="{{ $dosen->nip }}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputPassword3" class="col-sm-2 col-form-label">Nama</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputPassword3" name="nama" value="{{ $dosen->nama }}">
                  </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="custom-select" name="jurusan">
                            <option selected>{{ $dosen->status }}</option>
                            <option value="Teknik Informatika">PNS</option>
                            <option value="Teknin Mesin">NON-PNS</option>
                          </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputPassword3" name="tempat_lahir" value="{{ $dosen->tempat_lahir }}">
                    </div>
                </div>
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="inputPassword3" name="tanggal_lahir" value="{{ $dosen->tanggal_lahir }}">
                </div>
              </div>
