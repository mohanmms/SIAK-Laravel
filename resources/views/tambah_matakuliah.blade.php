    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info">
      ...
      <div class="row no-gutters">
          ...
          <div class="col-md-9 mt-5 ml-5">
              ...
              <h3><i class="fa fa-clipboard"></i> TAMBAH MATAKULIAH</h3><hr>
              ...
              <form method="post" action="/matakuliah/store">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="kode_mk">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputPassword3" class="col-sm-2 col-form-label">Matakuliah</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputPassword3" name="nama_mk">
                  </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="input" class="form-control" name="sks" id="">
                    </div>
                </div>
