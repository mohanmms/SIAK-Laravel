    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info">
      ...
      <div class="row no-gutters">
          ...
          <div class="content col-md-9 mt-5 ml-5">
            ...
            <div>
                <h3><i class="fas fa-chalkboard-teacher"></i> DOSEN</h3><hr>
            </div>

            <div>
                <form class="form-inline my-2 my-lg-0 ml-auto" method="post" action="/dosen/cari">
                    {{ csrf_field() }}
            ...
            <div class="mt-4">
                <a href="/dosen" >Tampilkan Semua</a>
            </div>
            ...
            <div class="table-wrapper mt-4">
              <div class="table-scroll">
                <table class="table table-fixed">
                  <thead>
                    <tr>
                      ...
                      <th scope="col" class="text">NIP</th>
                  ...
                  <tbody>
                      ...
                      @foreach ($dosen as $d)
                        <tr>
                            ...
                            <td>
                            <a href="/dosen/edit/{{ $d->id }}"><i class="fas fa-edit mr-4"></i></a>
                            <a href="/dosen/delete/{{ $d->id }}"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                        @php ($i++)
                      @endforeach
                ...
                <div>
                <a href="/dosen/tambah/"><button class="btn btn-secondary ml-auto">Tambah</button></a>
                </div>
              </div>
