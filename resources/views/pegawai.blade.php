    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info">
      ...
      <div class="row no-gutters">
          ...
          <div class="content col-md-9 mt-5 ml-5">
            ...
            <h3><i class="fa fa-user"></i> PEGAWAI</h3><hr>

            <div>
                <form class="form-inline my-2 my-lg-0 ml-auto" method="post" action="/pegawai/cari">
                    {{ csrf_field() }}
            ...
            <div class="mt-4">
                <a href="/pegawai" >Tampilkan Semua</a>
            </div>
            ...
            <div class="table-wrapper mt-4">
              <div class="table-scroll">
                    ...
                    @php ($i=1)
                      @foreach ($pegawai as $p)
                        ...
                        <td>{{$p->tempat_lahir}}, {{ $p->tanggal_lahir}}</td>
                            <td>
                            <a href="/pegawai/edit/{{ $p->id }}"><i class="fas fa-edit mr-4"></i></a>
                            <a href="/pegawai/hapus/{{ $p->id }}"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                        @php ($i++)
                      @endforeach
                ...
                <div>
                    <a href="/pegawai/add"><button class="btn btn-secondary ml-auto">Tambah</button></a>
                </div>
              </div>
