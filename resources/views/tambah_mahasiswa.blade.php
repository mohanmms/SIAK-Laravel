    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info">
      ...
      <div class="row no-gutters">
          ...
          <div class="col-md-9 mt-5 ml-5">
              ...
              <h3><i class="fas fa-user-graduate"></i> TAMBAH MAHASISWA</h3><hr>
              ...
              <form method="post" action="/mahasiswa/store">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputPassword3" name="tempat_lahir">
                    </div>
                </div>
                ...
                <div class="col-sm-10">
                    <input type="date" placeholder="yyyy/mm/dd" required pattern="(?:19|20)\[0-9\]{2}-(?:(?:0\[1-9\]|1\[0-2\])/(?:0\[1-9\]|1\[0-9\]|2\[0-9\])|(?:(?!02)(?:0\[1-9\]|1\[0-2\])/(?:30))|(?:(?:0\[13578\]|1\[02\])-31))" class="form-control" id="inputPassword3" name="tanggal_lahir">
                </div>
              </div>
