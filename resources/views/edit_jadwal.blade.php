          ...
          <div class="col-md-9 mt-5 ml-5">
              ...
              <form method="post" action="/jadwal/update">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputEmail3" name="nip" value="{{ $jadwal->matakuliah->nama_mk }}">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputPassword3" class="col-sm-2 col-form-label">Hari</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputPassword3" name="nama" value="{{ $jadwal->hari }}">
                  </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputPassword3" name="tempat_lahir" value="{{ $jadwal->dosen->nama }}">
                    </div>
                </div>
              </div>
