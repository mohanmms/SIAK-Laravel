    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info">
      ...
      <div class="row no-gutters">
          ...
          <div class="content col-md-9 mt-5 ml-5">
            ...
            <h3><i class="fa fa-calendar"></i> Matakuliah</h3><hr>
            ...
            <div class="table-wrapper">
              <div class="table-scroll">
                <table class="table table-fixed mt-5">
                  <thead>
                    <tr>
                      ...
                      <th scope="col" class="text">Kode Mata Kuliah</th>
                      <th scope="col" class="text">Mata Kuliah</th>
                      <th scope="col" class="text">SKS</th>
                  ...
                  <tbody>
                      @foreach ($mata_kuliah as $m)
                        ...
                        <tr>
                            ...
                            <td>{{$m->sks}}</td>
                            <td>
                            <a href="/matakuliah/edit"><i class="fas fa-edit mr-4"></i></a>
                            <a href="/matakulaih/hapus"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                        @php ($i++)
                      @endforeach
                ...
                <div>
                    <a href="/matakuliah/add"><button class="btn btn-secondary ml-auto">Tambah</button></a>
                </div>
              </div>
