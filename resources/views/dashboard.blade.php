            ...
            <div class="cards">
                 <div class="card bg-success" style="width: 14rem;">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text text-white"><a href="/mahasiswa" class="text-white">Lihat Detail</a></p>
                    </div>
                  </div>
                  ...
                  <div class="card bg-success" style="width: 14rem;">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text text-white"><a href="/dosen" class="text-white">Lihat Detail</a></p>
                    </div>
                  </div>
                  ...
                  <div class="card bg-success" style="width: 14rem;">
                    ...
                    <div class="card-body">
                      <h5 class="card-title text-white">Jumlah Pegawai</h5>
                      <h1 class="text-white">{{ $pegawai }}</h1>
                      <p class="card-text text-white"><a href="/pegawai" class="text-white">Lihat Detail</a></p>
                    </div>
                  </div>
            </div>
